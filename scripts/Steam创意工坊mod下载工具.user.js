            ...
            GM_xmlhttpRequest({
                ...
                onload: function(e){
                    ...
                    if(!e.response){
                        ...
                        endModDown(startMid, `[workshop-${startMid}]${collectionName?collectionName:""}.zip`)
                        return
                    }
                    ...
                    if(data.children && isCollection){
                        ...
                        if(nextUrlIndex < urls.length){
                            console.log(`${url} --> 获取MOD失败 正在切换至 ${urls[nextUrlIndex]} 进行尝试`)
              ...
              onload: function(e){
                  ...
                  if(e.response.uuid){
                      ...
                      if(nextUrlIndex < getUUids.length){
                            console.log(`${url} --> 获取UUID失败 正在切换至 ${getUUids[nextUrlIndex]} 进行尝试`)
