// ==UserScript==
// @name        9dm随机回帖
// @namespace   9大妈一键随机回复帖子, 切勿滥用, 违反9大妈论坛的规矩导致的后果, 作者一概不负
...
// @version     1.0
// @author      六记
// @description 2021/7/13 下午2:02:19
// @updateURL    https://cdn.jsdelivr.net/gh/ACG-Q/script@master/『分类』论坛回复🔈/9dm随机回帖.js
// ==/UserScript==
...
(function () {
  ...
  try{
    ...
    let ul = document.querySelector(".c1scrolltop>ul").innerHTML;
